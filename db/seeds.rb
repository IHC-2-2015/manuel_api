...
Opcione.create( valor: 0 , opcion_text: 'No cumple las tareas asignadas',pregunta_id: p1.id )
Opcione.create( valor: 1 , opcion_text: 'Cumple parcialmente o se retrasa',pregunta_id: p1.id)
Opcione.create( valor: 2 , opcion_text: 'Cumple en el plazo establecido con la tarea correspondiente',pregunta_id: p1.id )
Opcione.create( valor: 3 , opcion_text: 'Cumple con la tarea y la calidad supone un aporte notable',pregunta_id: p1.id )
Opcione.create( valor: 4 , opcion_text: 'Cumple con la tarea y su trabajo aporta, orienta y facilita la del resto del equipo',pregunta_id: p1.id )

Opcione.create( valor: 0 , opcion_text: 'Se ausenta con facilidad y su presencia es irrelevante',pregunta_id: p2.id)
Opcione.create( valor: 1 , opcion_text: 'Interviene poco, pero atiende a los requerimientos del resto.',pregunta_id: p2.id )
Opcione.create( valor: 2 , opcion_text: 'En general, se muestra activo y participativo',pregunta_id: p2.id )
Opcione.create( valor: 3 , opcion_text: 'Fomenta la participación y mejora la calidad de los resultados del equipo',pregunta_id: p2.id )
Opcione.create( valor: 4 , opcion_text: 'Sus aportes son fundamentales tanto para la calidad como el resultado del producto',pregunta_id: p2.id )

Opcione.create( valor: 0 , opcion_text: 'Se resiste a trabajar en equipo',pregunta_id: p3.id )
Opcione.create( valor: 1 , opcion_text: 'Se limita a aceptar la organización propuesta por los otros miembros',pregunta_id: p3.id )
Opcione.create( valor: 2 , opcion_text: 'Participa en la planificación, organización y distribución de tareas',pregunta_id: p3.id)
Opcione.create( valor: 3 , opcion_text: 'Es organizado y distribuye el trabajo con eficacia',pregunta_id: p3.id )
Opcione.create( valor: 4 , opcion_text: 'Fomenta la organización del trabajo aprovechando los recursos y habilidades del equipo',pregunta_id: p3.id )

Opcione.create( valor: 0 , opcion_text: 'Persigue objetivos personales',pregunta_id: p4.id )
Opcione.create( valor: 1 , opcion_text: 'Le cuesta integrar los objetivos personales con los del equipo',pregunta_id: p4.id )
Opcione.create( valor: 2 , opcion_text: 'Asume como propios los objetivos del equipo',pregunta_id: p4.id )
Opcione.create( valor: 3 , opcion_text: 'Promueve la definición de objetivos de manera clara e integrando al equipo en torno a los mismos',pregunta_id: p4.id )
Opcione.create( valor: 4 , opcion_text: 'Moviliza y cohesiona al equipo para alcanzar objetivos más exigentes',pregunta_id: p4.id )

Opcione.create( valor: 0 , opcion_text: 'No escucha las intervenciones de sus compañeros y las descalifica sistemáticamente',pregunta_id: p5.id )
Opcione.create( valor: 1 , opcion_text: 'Escucha poco, no pregunta, no se preocupa por la opinión ajena',pregunta_id: p5.id )
Opcione.create( valor: 2 , opcion_text: 'Acepta las opiniones de otros y sabe dar su punto de vista constructivamente',pregunta_id: p5.id )
Opcione.create( valor: 3 , opcion_text: 'Fomenta el diálogo constructivo e inspira la participación de los otros miembros del equipo',pregunta_id: p5.id )
Opcione.create( valor: 4 , opcion_text: 'Integra las opiniones ajenas en una perspectiva superior, manteniendo un clima de colaboración y apoyo',pregunta_id: p5.id )

Opcione.create( valor: 0 , opcion_text: 'Definitivamente no',pregunta_id: p6.id )
Opcione.create( valor: 1 , opcion_text: 'Posiblemente no',pregunta_id: p6.id )
Opcione.create( valor: 2 , opcion_text: 'Me es indiferente',pregunta_id: p6.id )
Opcione.create( valor: 3 , opcion_text: 'Posiblemente sí',pregunta_id: p6.id )
Opcione.create( valor: 4 , opcion_text: 'Definitivamente sí',pregunta_id: p6.id )

Opcione.create( valor: 0 , opcion_text: 'Es un pésimo jefe; genera mucho caos y conflicto',pregunta_id: p7.id )
Opcione.create( valor: 1 , opcion_text: 'Es un jefe con muchas faltas de liderazgo',pregunta_id: p7.id )
Opcione.create( valor: 2 , opcion_text: 'Es un jefe normal con defectos y virtudes',pregunta_id: p7.id )
Opcione.create( valor: 3 , opcion_text: 'Es un jefe que coordina y nos hace trabajar',pregunta_id: p7.id )
Opcione.create( valor: 4 , opcion_text: 'Es un excelente jefe que nos hace colaborar por un sentido común',pregunta_id: p7.id )

Opcione.create( valor: 0 , opcion_text: 'Siento que cumplí con lo básico que se me pidió que hiciera',pregunta_id: p8.id )
Opcione.create( valor: 1 , opcion_text: 'Siento que pude haber hecho mucho más',pregunta_id: p8.id )
Opcione.create( valor: 2 , opcion_text: 'Siento que cumplí lo necesario',pregunta_id: p8.id )
Opcione.create( valor: 3 , opcion_text: 'Siento que aporte más de lo pedido',pregunta_id: p8.id )
Opcione.create( valor: 4 , opcion_text: 'Me siento orgullo del nivel del trabajo y aporte que hice al proyecto',pregunta_id: p8.id )
