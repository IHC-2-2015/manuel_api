...
class EncuestaPreguntaControllerTest < ActionController::TestCase
  ...
  test "should create encuesta_preguntum" do
    assert_difference('EncuestaPreguntum.count') do
      post :create, encuesta_preguntum: { encuesta_id: @encuesta_preguntum.encuesta_id, pregunta_id: @encuesta_preguntum.pregunta_id }
    end
  ...
  test "should update encuesta_preguntum" do
    patch :update, id: @encuesta_preguntum, encuesta_preguntum: { encuesta_id: @encuesta_preguntum.encuesta_id, pregunta_id: @encuesta_preguntum.pregunta_id }
    assert_redirected_to encuesta_preguntum_path(assigns(:encuesta_preguntum))
  end
